...
namespace UiProjector
{
    ...
    public readonly struct CanvasHandle : IDisposable
    {
        ...
        public UiHandle Add(RectTransform ui, Transform target, Vector3 worldSpaceOffset, Vector2 screenSpaceOffset, IProjectionReviser reviser = null, Action<RectTransform> releaseAction = null)
        {
        ...
        public UiHandle Add(RectTransform ui, Transform target, Vector3 worldSpaceOffset, IProjectionReviser reviser = null, Action<RectTransform> releaseAction = null) => Add(ui, target, worldSpaceOffset, Vector2.zero, reviser, releaseAction);
        ...
        public UiHandle Add(RectTransform ui, Transform target, Vector2 screenSpaceOffset, IProjectionReviser reviser = null, Action<RectTransform> releaseAction = null) => Add(ui, target, Vector3.zero, screenSpaceOffset, reviser, releaseAction);
        ...
        public UiHandle Add(RectTransform ui, Transform target, IProjectionReviser reviser = null, Action<RectTransform> releaseAction = null) => Add(ui, target, Vector3.zero, Vector2.zero, reviser, releaseAction);
